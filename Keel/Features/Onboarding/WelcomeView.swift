    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 0) {
                ...
                Text("Let's keep track of what's been happening.")
                    .onboardingSubtitle()
                    .foregroundStyle(theme.heading.opacity(0.85))
                    .padding(.top, Spacing.md)
                Text("A calm companion for the years when your body stops feeling familiar, and you want a record you can trust.")
                    .font(KeelFont.body)
